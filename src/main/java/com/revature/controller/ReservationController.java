...
public class ReservationController {
    ...
    public ReservationWithDetailsDTO createReservationByRoomTypeHandler(@AuthenticationPrincipal CustomUserDetails userDetails,@RequestBody ReservationCreateDTO reservationCreateDTO){
        return reservationService.createReservation(userDetails.getUserId(),reservationCreateDTO);
    }
    @PreAuthorize("hasRole('USER')")
    @GetMapping("user")
    public List<ReservationWithDetailsDTO> getUserReservationHandler(@AuthenticationPrincipal CustomUserDetails userDetails){
        return reservationService.getUserReservations(userDetails.getUserId());
    }

    @GetMapping("{reservationId}")
    public ReservationWithDetailsDTO getReservationHandler(@AuthenticationPrincipal CustomUserDetails userDetails,@PathVariable int reservationId){
    ...
    @PostMapping("/filter")
    public List<ReservationWithDetailsDTO> filterReservationsHandler(@AuthenticationPrincipal CustomUserDetails userDetails, @RequestBody ReservationFilterDTO filter) throws ParseException {
    ...
    public Reservation updateReservationStatusHandler(@AuthenticationPrincipal CustomUserDetails userDetails,@PathVariable int reservationId, @RequestBody ReservationUpdateStatusDTO reservationUpdateStatusDTO){
